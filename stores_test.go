...
func TestDetectStore(t *testing.T) {
	cases := map[string]string{
		...
		"https://store.nintendo.com/es-es/nintendo-switch-2-edicin-40-aniversario-de-the-legend-of-zelda-P00211": "nintendo",
		"https://store.nintendo.com/es-es/mario-kart-world-70010000096802":                                       "nintendo",
	}
